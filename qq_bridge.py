...
DEFAULT_INPUT = STORAGE_DIR / "lark-notifications.jsonl"
DEFAULT_STATE = STORAGE_DIR / ".qq-forwarder-state.json"
DEFAULT_CHANNEL_STATE = STORAGE_DIR / ".lark-channel-cursors.json"
